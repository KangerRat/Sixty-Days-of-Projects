...
public class SimpleChatBot {
    public static void main(String[] args){
        ...
        System.out.println(userInput + " User");
            ...
            System.out.println("I'm well");
        }
        else if((userInput.equalsIgnoreCase("How's the weather")) || (userInput.equalsIgnoreCase("Weather") )){
            System.out.println("It's nice and sunny");
        }
        else if((userInput.equalsIgnoreCase("bye")) || (userInput.equalsIgnoreCase("Goodbye") )){
            System.out.println("bye bye, User");
        }
        else{
            System.out.println("How it's going, User");
        }

        scanner.close();

        /*
        the other options is like this:
        public class SimpleChatbot {
    public static void main(String[] args) {
